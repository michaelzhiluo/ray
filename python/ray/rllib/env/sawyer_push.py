...
class SawyerPushEnv(FlatGoalEnv, Env):
    """
    ...
    def set_task(self, task):
        ...
        """
        #print("obj_high", self.obj_space.high)
        #print("obj_low", self.obj_space.low)
        #print("goal_high", self.goal_space.high)
        #print("goal_low", self.goal_space.low)
